...
Route::middleware(['auth'])->group(function () {
    ...
    // ====================================================
    // KHUSUS ROLE: PETUGAS (Akses Dashboard & Logistik)
    // ====================================================
    Route::middleware(['role:petugas'])->group(function () {
        
        // Dashboard Petugas Biasa
    ...
    // ====================================================
    // KHUSUS ROLE: ADMIN (Akses Kontrol & Management)
    // ====================================================
    Route::middleware(['role:admin'])->group(function () {
        
        // Dashboard Khusus Admin
        Route::get('/dashboard/admin', [HomeController::class, 'adminIndex'])->name('home.admin');
